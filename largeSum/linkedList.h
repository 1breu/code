...
///@file        linkedList.h
///@version     2021-02-11
///@brief       This is the header file for linkedList class object.
...
public:
    ...
    void divideAt(linkedListType &secondList, const Type& item);
...
template <class Type>
void linkedListType<Type>::divideAt(linkedListType &secondList,
                                    const Type& item)
{
	...
	if (first == nullptr)
	{
		...
		secondList.first = nullptr;
		secondList.last = nullptr;
        secondList.count = 0;
	}
	else
	{
